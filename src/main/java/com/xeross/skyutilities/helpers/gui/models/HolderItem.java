...
public class HolderItem<O extends Enum<O> & MessageType> {
    ...
    public HolderItem(O type, ItemCreator item, String[] keys, ConfiguratorHolderMessageAPI[] value, HolderItemAPI api) {
        this.type = type;
        this.item = item;
        this.keys = keys;
        this.value = value;
