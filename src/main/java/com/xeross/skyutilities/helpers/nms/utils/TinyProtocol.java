package com.xeross.skyutilities.helpers.nms.utils;
...
/**
 * Minimized version of TinyProtocol by Kristian
 */
@SuppressWarnings({"FieldMayBeFinal", "FieldCanBeLocal", "FinalMethodInFinalClass", "unused", "rawtypes", "CommentedOutCode"})
public abstract class TinyProtocol {
    ...
    protected TinyProtocol(JavaPlugin main) {
        this.plugin = main;
        this.instance = main;
